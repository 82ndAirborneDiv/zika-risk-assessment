CDC.Datamap = function (c, $, w, _) {    
    ...
    */    
    ...
    handleMouseMove = function (stateId, d) {
        if (!inVP1) {
            ...
            if (stateObj) {
                ...
                //handleTooltip(filteredData[stateId].statename, dataColumnFriendlyName, filteredData[stateId][dataColumnName], mouse, null);
    ...
    handleTooltip = function (stateId, mouse) {
        ...
        $tooltipObj.append('<div>'+dataColumnFriendlyName+': ' + dataPrefix + stateData[dataColumnName] + dataSuffix +'</div>');
    ...
    drawRawDataTable = function (localTimeSeriesIndex) {
        ...
        if (!localTimeSeriesIndex || localTimeSeriesIndex === currentTimeSeriesIndex) {
            ...
            $rawDataContainer.append(collapsibleModuleHtml);
